...
import * as ViewerDiagramJsCss from "bpmn-js/dist/assets/diagram-js.css?shadow";
import * as ViewerBpmnJsCss from "bpmn-js/dist/assets/bpmn-js.css?shadow";
import * as SimulatorCss from "bpmn-js-token-simulation/assets/css/bpmn-js-token-simulation.css?shadow";
...
export class BPMNViewer extends LitElement {
  ...
  static override get styles() {
    return [
      ...
      `,
      css`
        ${unsafeCSS(ViewerDiagramJsCss.default)}
      `,
      css`
        ${unsafeCSS(ViewerBpmnJsCss.default)}
      `,
      css`
        ${unsafeCSS(SimulatorCss.default)}
      `,
    ];
  }
